...
> *The Plant Genome* [doi:10.3835/plantgenome2018.01.0006](https://doi:10.3835/plantgenome2018.01.0006)
...
> from two bulked populations. *Plant J*, 74: 174–183. [doi:10.1111/tpj.12105](https://doi:10.1111/tpj.12105)
...
> [doi.org/10.1371/journal.pcbi.1002255](https://doi.org/10.1371/journal.pcbi.1002255)
...
While GATK has its own filtering tools, QTLseqr offers some options for filtering that may help reduce noise and improve results. Filtering is mainly based on read depth for each SNP, such that we can try to eliminate SNPs with low confidence, due to low coverage, and SNPs that may be in repetitive regions and thus have inflated read depth. If you have your own quality columns you can always use R's base subsetting functions to filter out any SNPs you don't want. 
