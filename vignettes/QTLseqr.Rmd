...
```{r gprimedist hampel, message = FALSE, warning = FALSE, fig.align = "center"}
plotGprimeDist(SNPset = df_filt, outlierFilter = "Hampel")

```

```{r gprimedist deltaSNP, message=FALSE, warning = FALSE, fig.align = "center"}
...
```{r subsetlogpval, fig.align="center", fig.width=4, fig.height=4}
